...
const CreateContact = ({ edit }: any) => {
  ...
  <div className="lg:w-[1190px] w-full">
    ...
    <div className="border border-primary lg:w-[450px] lg:m-auto m-5 p-6 rounded flex flex-col gap-6 bg-gray-100">
      <Input
        label="First Name"
        placeholder="John"
      ...
      <div className="flex justify-center items-center">
        <Button
          ...
          className="bg-gradient-to-r from-indigo-500 to-blue-500 hover:from-indigo-600 hover:to-blue-600 text-white py-3 px-6 rounded-md shadow-md transition duration-300"
        />
      </div>
    </div>
  </div>
